        ...
        <div className="about_side-menu">
            ...
            <ul className="about_side-menu_list">
                <li className={activeListItem == "user_agreement" ?
                    ...
                    User agreement</li>
                <li className={activeListItem == "pay_order" ?
                    "about_side-menu_list_item about_side-menu_list_item_active" :
                    "about_side-menu_list_item"}
                    onClick={() => setActiveListitem("pay_order")}>
                    How can I pay for the order?</li>
                <li className={activeListItem == "worldwide" ?
                    "about_side-menu_list_item about_side-menu_list_item_active" :
                    "about_side-menu_list_item"}
                    onClick={() => setActiveListitem("worldwide")}>
                    Is it possible to order goods with delivery to another country?</li>
                <li className={activeListItem == "return_and_exchange" ?
                    "about_side-menu_list_item about_side-menu_list_item_active" :
                    "about_side-menu_list_item"}
                    onClick={() => setActiveListitem("return_and_exchange")}>
                    Return and exchange conditions</li>

            </ul>
            <div className="about_main_help">
                <div className="about_main_help_text">Still need our help?</div>
                <Link to="/contact"><button className="about_main_help_btn">Contact us</button></Link>
            </div>
        </div>
    </div>
}
